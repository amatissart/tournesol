...
def save_data(entity_scores, contributor_rating_scores, poll, trusted_only=True):
    """
...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            "--algorithm",
            default=ALGORITHM_LICCHAVI,
            help="Algorithm to use, 'licchavi' or 'mehestan'",
        )
    ...
    def handle(self, *args, **options):
        ...
        if TOURNESOL_DEV:
            ...
            for poll in Poll.objects.all():
                ...
                if algorithm == ALGORITHM_LICCHAVI:
                ...
                elif algorithm == ALGORITHM_MEHESTAN:
